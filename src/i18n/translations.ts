...
export const translations = {
  uz: {
    ...
    'checkout.selectedBadge': 'Tanlandi',
    'checkout.noAddressTitle': 'Manzil tanlanmagan',
    'checkout.noAddressBody': "Buyurtmani qayerga yetkazishimizni bilishimiz uchun manzilni tanlang.",
    'checkout.noAddressEmptyBody': "Hali saqlangan manzilingiz yo'q. Xaritadan birinchi manzilingizni belgilang.",
    ...
    'checkout.zoneChecking': 'Tekshirilmoqda…',
    'checkout.zoneIn': 'Yetkazib beriladi',
    'checkout.zoneOut': 'Zonadan tashqarida',
    'checkout.distance': '{km} km',
    'checkout.detailsHint': 'Kuryer sizni tez topishi uchun',
    'checkout.contactTitle': 'Aloqa',
    'checkout.itemsTitle': 'Buyurtma tarkibi',
    'checkout.summaryTitle': 'Hisob',
    'checkout.commentPlaceholder': "Masalan: eshik qo'ng'irog'i ishlamaydi",
  ...
  uz_cyrl: {
    ...
    'checkout.selectedBadge': 'Танланди',
    'checkout.noAddressTitle': 'Манзил танланмаган',
    'checkout.noAddressBody': 'Буюртмани қаерга етказишимизни билишимиз учун манзилни танланг.',
    'checkout.noAddressEmptyBody': 'Ҳали сақланган манзилингиз йўқ. Харитадан биринчи манзилингизни белгиланг.',
    ...
    'checkout.zoneChecking': 'Текширилмоқда…',
    'checkout.zoneIn': 'Етказиб берилади',
    'checkout.zoneOut': 'Зонадан ташқарида',
    'checkout.distance': '{km} км',
    'checkout.detailsHint': 'Курьер сизни тез топиши учун',
    'checkout.contactTitle': 'Алоқа',
    'checkout.itemsTitle': 'Буюртма таркиби',
    'checkout.summaryTitle': 'Ҳисоб',
    'checkout.commentPlaceholder': 'Масалан: эшик қўнғироғи ишламайди',
  ...
  ru: {
    ...
    'checkout.selectedBadge': 'Выбран',
    'checkout.noAddressTitle': 'Адрес не выбран',
    'checkout.noAddressBody': 'Укажите адрес, чтобы мы знали, куда доставить заказ.',
    'checkout.noAddressEmptyBody': 'У вас пока нет сохранённых адресов. Отметьте первый адрес на карте.',
    ...
    'checkout.zoneChecking': 'Проверяем…',
    'checkout.zoneIn': 'Доставим',
    'checkout.zoneOut': 'Вне зоны доставки',
    'checkout.distance': '{km} км',
    'checkout.detailsHint': 'Чтобы курьер быстрее вас нашёл',
    'checkout.contactTitle': 'Контакты',
    'checkout.itemsTitle': 'Состав заказа',
    'checkout.summaryTitle': 'Счёт',
    'checkout.commentPlaceholder': 'Например: не работает дверной звонок',
